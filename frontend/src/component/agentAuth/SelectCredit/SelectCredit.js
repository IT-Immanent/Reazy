                ...
                <div className="AgetSelctCardbox">
                    <div className="Reazy_Credits">
                        ...
                        <div className="reazyCreditsData">
                            <h2>Reazy Credits</h2>
                            <p>You’ll need credits in your account to reveal pre-approved tenants for your property listings.</p>
                            <h4>Learn more</h4>
                        </div>
                    </div>
                    ...
                    <div className="selct_contact">
                        ...
                        <div className="slctChat">
                            <a className='MainBTNPink' href="#"><i class="fa-regular fa-comments"></i> Chat to us</a>
                        </div>
                        <div className="selct_button">
                            <a className='MainBTN2' href="#">Purchase later</a>
                            <a className='MainBTN' href="#">Continue</a>
                        </div>
